...
public static class FeatureCatalog
{
    ...
    [
        ...
        new(Guid.Parse("f1000022-0028-4028-8028-000000000022"), FeatureCodes.ServiceRelocateTable, "Cambiar / fusionar mesa", "Servicio", 25),
        new(Guid.Parse("f1000023-0029-4029-8029-000000000023"), FeatureCodes.ServiceCancelOrder, "Anular productos / pedido", "Servicio", 26),
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> DefaultFeaturesByRole { get; } =
        new Dictionary<string, IReadOnlyList<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [
                ...
                FeatureCodes.ServiceRelocateTable,
                FeatureCodes.ServiceCancelOrder,
