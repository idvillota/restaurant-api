        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillNumber = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseLines_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseLines_IngredientId",
                table: "PurchaseLines",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseLines_PurchaseId_IngredientId",
                table: "PurchaseLines",
                columns: new[] { "PurchaseId", "IngredientId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_TenantId_BillNumber",
                table: "Purchases",
