        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zone = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationTables_DiningTables_DiningTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_TenantUsers_TenantUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantUserId",
                table: "Employees",
                column: "TenantUserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationTables_DiningTableId",
                table: "ReservationTables",
                column: "DiningTableId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationTables_ReservationId_DiningTableId",
                table: "ReservationTables",
                columns: new[] { "ReservationId", "DiningTableId" },
                unique: true);
